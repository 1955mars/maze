...
public class Door : MonoBehaviour {
    ...
    Quaternion leftDoorEndtRotation;
    ...
    void Start () {
        ...
        leftDoorEndtRotation = leftDoorStartRotation * Quaternion.Euler(0.0f, 0.0f, -90.0f);
	...
	void Update () {
        ...
        if (opening)
        {
            ...
            leftDoor.transform.rotation = Quaternion.Slerp(leftDoorStartRotation, leftDoorEndtRotation, timer / rotationTime);
